...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.categories'
        db.add_column('knowledge_question', 'categories',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['knowledge.Category'], blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Question.categories'
        db.delete_column('knowledge_question', 'categories_id')
    ...
    models = {
        ...
        'knowledge.question': {
            ...
            'categories': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['knowledge.Category']", 'blank': 'True'}),
