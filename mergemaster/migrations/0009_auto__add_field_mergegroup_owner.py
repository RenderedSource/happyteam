...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MergeGroup.owner'
        db.add_column('mergemaster_mergegroup', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MergeGroup.owner'
        db.delete_column('mergemaster_mergegroup', 'owner_id')
