...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        default_merge_group = orm.MergeGroup(main_branch = 'origin/develop')
        default_merge_group.save()
        for merge_request in orm.MergeRequest.objects.all():
            merge_request.merge_group = default_merge_group
            merge_request.save()
