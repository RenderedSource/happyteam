...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MergeRequest.merge_group'
        db.alter_column('mergemaster_mergerequest', 'merge_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mergemaster.MergeGroup']))

    def backwards(self, orm):

        # Changing field 'MergeRequest.merge_group'
        db.alter_column('mergemaster_mergerequest', 'merge_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mergemaster.MergeGroup'], null=True))
