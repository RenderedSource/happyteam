...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MergeRequestAction.new_merge_status'
        db.add_column('mergemaster_mergerequestaction', 'new_merge_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MergeRequestAction.new_cr_status'
        db.add_column('mergemaster_mergerequestaction', 'new_cr_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MergeRequestAction.new_qa_status'
        db.add_column('mergemaster_mergerequestaction', 'new_qa_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MergeRequest.merge_status'
        db.add_column('mergemaster_mergerequest', 'merge_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MergeRequest.cr_status'
        db.add_column('mergemaster_mergerequest', 'cr_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MergeRequest.qa_status'
        db.add_column('mergemaster_mergerequest', 'qa_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MergeRequestAction.new_merge_status'
        db.delete_column('mergemaster_mergerequestaction', 'new_merge_status')

        # Deleting field 'MergeRequestAction.new_cr_status'
        db.delete_column('mergemaster_mergerequestaction', 'new_cr_status')

        # Deleting field 'MergeRequestAction.new_qa_status'
        db.delete_column('mergemaster_mergerequestaction', 'new_qa_status')

        # Deleting field 'MergeRequest.merge_status'
        db.delete_column('mergemaster_mergerequest', 'merge_status')

        # Deleting field 'MergeRequest.cr_status'
        db.delete_column('mergemaster_mergerequest', 'cr_status')

        # Deleting field 'MergeRequest.qa_status'
        db.delete_column('mergemaster_mergerequest', 'qa_status')
