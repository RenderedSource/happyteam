...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MergeActionComment'
        db.create_table('mergemaster_mergeactioncomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('merge_action', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mergemaster.MergeRequestAction'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('mergemaster', ['MergeActionComment'])


    def backwards(self, orm):
        # Deleting model 'MergeActionComment'
        db.delete_table('mergemaster_mergeactioncomment')
